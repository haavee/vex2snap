...
_lr_productions = [
  ...
  ('vex -> vex_header blocks','vex',2,'p_vex','vex.py',104),
  ('vex_header -> IDENT EQ IDENT SEMICOLON','vex_header',4,'p_vex_header','vex.py',109),
  ('blocks -> block','blocks',1,'p_blocks','vex.py',115),
  ('blocks -> blocks block','blocks',2,'p_blocks','vex.py',116),
  ('block -> block_header block_content','block',2,'p_block','vex.py',124),
  ('block_header -> DOLLAR IDENT SEMICOLON','block_header',3,'p_block_header','vex.py',130),
  ('block_content -> block_lines','block_content',1,'p_block_content','vex.py',135),
  ('block_content -> block_content def_block','block_content',2,'p_block_content','vex.py',136),
  ('block_content -> block_content scan_block','block_content',2,'p_block_content','vex.py',137),
  ('def_block -> DEF word SEMICOLON block_lines ENDDEF SEMICOLON','def_block',6,'p_def_block','vex.py',145),
  ('scan_block -> SCAN word SEMICOLON block_lines ENDSCAN SEMICOLON','scan_block',6,'p_scan_block','vex.py',151),
  ('block_lines -> <empty>','block_lines',0,'p_block_lines','vex.py',157),
  ('block_lines -> block_lines block_line','block_lines',2,'p_block_lines','vex.py',158),
  ('block_line -> REF DOLLAR word EQ value SEMICOLON','block_line',6,'p_block_line','vex.py',168),
  ('block_line -> word EQ value SEMICOLON','block_line',4,'p_block_line','vex.py',169),
  ('value -> word','value',1,'p_value','vex.py',179),
  ('value -> <empty>','value',0,'p_value','vex.py',180),
  ('value -> value COLON word','value',3,'p_value','vex.py',181),
  ('value -> value COLON','value',2,'p_value','vex.py',182),
  ('word -> IDENT','word',1,'p_word','vex.py',200),
  ('word -> word IDENT','word',2,'p_word','vex.py',201),
]
